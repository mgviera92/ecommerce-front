                ...
                <Center>
                    <ColumnsWrapper>
                        <Box>
                            ...
                            <p>We will email you the details of your order soon.</p>
                        </Box>
                    </ColumnsWrapper>
                </Center>
            </>
            ...
            <ColumnsWrapper>
                ...
                {!!cartProducts?.length && (
                    ...
                    <h2>Order Info</h2>
                        ...
                        <Input type="text" placeholder="Street Address" value={streetAddress} name = 'streetAddress' onChange={e => setStreetAddress(e.target.value)}/>
